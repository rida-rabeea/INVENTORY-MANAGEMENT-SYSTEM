...
if (isset($_POST['seller_login'])) {
    ...
    if ($count > 0) {
        header("Location: seller_main_page.php"); // Redirect to your next page
        exit();
    } else {
...
if (isset($_POST['create_account'])) {
    $username = $_POST['email'];
    $password = $_POST['password'];
    $query = "INSERT INTO SELLER (EMAIL_ID, PASSWORD) VALUES ('$username', '$password')";
    $result = mysqli_query($connect, $query);
...
<body>
    ...
    <div class="container">
        <div id="login-form">
            <h2>Login</h2>
            <form method="post">
                <input type="email" name="email" placeholder="Seller Email ID" required>
        ...
        <div id="create-form" style="display:none;">
            ...
            <form action=insert_data_seller.php method="post">
                <input type="email" name="emailid" placeholder="Email ID" required>
                <input type="text" name="username" placeholder="Username" required>
                <input type="text" name="companyname" placeholder="Company Name" required>
                <input type="text" name="city" placeholder="City" required>
                <input type="password" name="password1" placeholder="Password" required>
                <button type="submit" name="create_account_seller">Create Account</button>
            </form>
